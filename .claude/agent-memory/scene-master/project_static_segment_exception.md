...
**🔄 2026-07-29 갱신: 그 예외는 이미 해소됐다.** ep01s 판정 때 다시 돌려 보니
**ep00s 는 최대 2.6s 로 통과**하고 **ep01s 는 최대 2.0s** 다. 즉 지금 리포에 초과 회차는 없다.
ep01s 는 열 kind 전부에 `t` 의 함수로 도는 요소를 심어(밝기만 흔드는 '숨쉬는 빛'은 0건) 상한 안에 들어왔다 —
