...
namespace AIVillage.M0
{
    ...
    public sealed class FightActionSO : ActionSO
    {
        [Tooltip("타격 사거리 (타일, 맨해튼). 이 안에 들어와야 때린다. 리뷰①에서 1 → 2 개정 " +
                 "(2026-08-08): 사거리 1은 배회 반경 5를 도는 위협이 매복지 1타일 안으로 들어와야만 " +
                 "맞아서 '근처에 있어도 안 싸우는' 판이 나왔다. 여전히 위협의 타격 반경(3~4)보다 " +
                 "**좁아야** 한다 — 위협이 먼저 닿고 주민이 파고들어야 '맞으면서 때린다'가 성립 " +
                 "(게이트 M21-T9 가 이 관계를 고정).")]
        public int StrikeRangeTiles = 2;

        [Tooltip("기본 타격 간격 (실시간 초). §4 제안치 4초 — 티어1 위협 60 체력을 맨손 10 피해로 " +
                 "6대(24초)에 몰아낸다. 직업·무기 배율이 여기에 곱해진다 (CombatService.HitInterval).")]
        public float BaseHitSec = 4f;

        [Tooltip("한 대의 피해량. §4 제안치 10 — 티어1 위협(60) 기준 4대에 도주선(24), 6대에 사냥. " +
        ...
        [Tooltip("매복 대기 상한 (실시간 초, 2026-08-08 개정 — 쫓지 않고 매복한다). 사거리 밖 대상을 " +
                 "기다리는 최대 시간. 재타격 주기(0.25일 = 25초)보다 길어야 위협이 한 번은 돌아온다. " +
