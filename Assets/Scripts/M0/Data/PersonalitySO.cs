...
namespace AIVillage.M0
{
    ...
    public sealed class PersonalitySO : ScriptableObject
    {
        ...
        [Header("택지 취향 (M11-F — 내 집이 설 자리. 기본값 0 = 중립: 마을 안쪽 선호)")]
        [Tooltip("택지 점수 가산 (HomePicker). 0 = 마을 앵커에 가까운 자리, 1 초과 = 바깥 자리 선호 " +
                 "(방랑벽 1.5 = 외딴집, 온순 0 = 이웃 곁). 직업 값과 합산된다 — 랜덤 아님(ADR-M11-5).")]
