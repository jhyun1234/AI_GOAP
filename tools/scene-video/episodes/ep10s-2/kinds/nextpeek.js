...
/* nextpeek — 아웃트로 샷(4단 고정 구조 ④). 다음 편 기능의 0.5초 테스트 장면을 루프로 돌린다.
   ...
   🔴 **분담(2026-08-08 사용자 2차 판정으로 개정).** 예고 자막이 「집이 저 혼자 지어지던
   기능을 일부러 지워요」로 바뀌면서 **자막도 「무엇을」까지 말한다.** 옛 주석의
   *"자막은 「지운다」, 화면은 「무엇을」"* 은 죽은 서술이라 지웠다.
   지금의 분담은 **층위**다 — 자막은 그 기능을 **이름으로** 부르고(그리고 지운다고 말하고),
   화면은 그것이 **실제로 돌아가는 모습**을 보인다. 「집이 저 혼자 지어진다」는 말은
   한 번 들으면 지나가지만, 여덟 바퀴 도는 것을 보면 **그게 계속 일어나는 일**이라는
   것과 **아무도 부탁하지 않았다**는 것이 함께 읽힌다. 자막이 못 지는 두 가지다.
