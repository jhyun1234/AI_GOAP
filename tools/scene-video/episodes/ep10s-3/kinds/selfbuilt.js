...
/* selfbuilt — 아무것도 안 지나는데 집이 선다.
   ...
   🔴 캡슐은 **부풀었다 도로 꺼진다.** 등장 자체는 cue(askCue)에 물려 있고, 부풀기는
...
export default {
  ...
  draw(root, { spec, t, cue }) {
    ...
    const c1 = cue(spec.askCue ?? 1, 0.15, 0.85);
    ...
    /* ── 부풀었다 꺼지는 요청 ──────────────────────
       등장은 cue(askCue), 부풀기는 t 의 연속 함수다. ph 가 0.62 를 넘으면 sin(π)=0 이라
       값이 이어진 채 사라진다 — 시각 문턱이 아니다. */
