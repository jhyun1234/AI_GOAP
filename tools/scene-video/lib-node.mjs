...
/* ⚠️ 이 아래는 호출부가 0 인 유휴 코드다(ADR-V-13 폐기 · 명세서 §7 스코프 가드).
   🔄 게다가 전제가 하나 더 무너졌다 — 2026-08-10 개정 ADR-V-10 으로 **화면 라벨이
   ep13s 부터 한국어**라, 「라벨은 언어 무관이니 상속한다」가 더는 성립하지 않는다.
   정리 배치에서 이 갈래를 걷어낼 때 이 줄이 근거다. 아래 설명은 **당시 기록**이다.
